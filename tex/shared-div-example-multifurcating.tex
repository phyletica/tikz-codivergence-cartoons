...
\centering{
\resizebox{!}{\headlessframetextheight}{%
...
\node[visible on=<2->] at (island) {\includegraphics[height=8.0cm]{../images/islands-3-bare.pdf}};
...
\draw [visible on=<2->] (n4px) -- (n4);
\draw [visible on=<2->] (n5px) -- (n5);
\draw [visible on=<2->] (n6p) -- (n6);
...
\draw [visible on=<2->] (n10px) -- (n10);
\draw [visible on=<2->] (n11px) -- (n11);
\draw [visible on=<2->] (n12p) -- (n12);
...
\draw [visible on=<2->] (n15px) -- (n15);
\draw [visible on=<2->] (n16px) -- (n16);
\draw [visible on=<2->] (n17p) -- (n17);
...
\draw [visible on=<2->,line cap=rect] (n4px) -- (n5px);
...
\draw [visible on=<2->,line cap=rect] (n10px) -- (n11px);
\draw [visible on=<2->,line cap=rect] (n14p) -- (n17p);
% \draw [visible on=<3>,line cap=rect] (n15p) -- (n16p);
\draw [visible on=<2->,line cap=rect] (n15px) -- (n16px);
...
\node [visible on=<2->] at (n4) {\hspace{20mm}\includegraphics[width=15mm]{../images/phylopics/gekko-vittatus-5-teal-shadow.png}};
\node [visible on=<2->] at (n5) {\hspace{20mm}\includegraphics[width=15mm]{../images/phylopics/gekko-vittatus-4-yellow-shadow.png}};
\node [visible on=<2->] at (n6) {\hspace{20mm}\includegraphics[width=15mm]{../images/phylopics/gekko-vittatus-6-auburn-shadow.png}};
\node [visible on=<2->] at (n10) {\hspace{20mm}\includegraphics[width=15mm]{../images/phylopics/gecko-pixabay-cc0-5-teal-shadow.png}};
\node [visible on=<2->] at (n11) {\hspace{20mm}\includegraphics[width=15mm]{../images/phylopics/gecko-pixabay-cc0-4-yellow-shadow.png}};
\node [visible on=<2->] at (n12) {\hspace{20mm}\includegraphics[width=15mm]{../images/phylopics/gecko-pixabay-cc0-6-auburn-shadow.png}};
\node [visible on=<2->] at (n15) {\hspace{20mm}\includegraphics[width=15mm]{../images/phylopics/gekko-gecko-5-teal-shadow.png}};
\node [visible on=<2->] at (n16) {\hspace{20mm}\includegraphics[width=15mm]{../images/phylopics/gekko-gecko-4-yellow-shadow.png}};
\node [visible on=<2->] at (n17) {\hspace{20mm}\includegraphics[width=15mm]{../images/phylopics/gekko-gecko-6-auburn-shadow.png}};
